def CreateRecipe():
  ...
  Drink = ''
  CreateType = input(
      "What type of recipe would you like to add, 1 Breakfast, 2 Lunch, 3 Dinner, 4 Snack, 5 Dessert, 6 Drink any other key press will back you out\n"
  )
  ...
  if MenuChoice == "1":
    ...
    with open("Breakfast.txt", "r") as f:
      ...
      for line in f:
        ...
        line_number += 1
    IndexFile = input(
        "Please Enter the recipe Number that you are interested in\n")
    index = int(IndexFile)
